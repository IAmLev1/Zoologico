...
public class FrameVentas extends javax.swing.JFrame {
    ...
    public FrameVentas() {
        ...
        blockCheckLZV();
        blockPlans();
        btnIngresoCliente.setEnabled(false);
        agregarCompra.setEnabled(false);
    ...
    private void initComponents() {
        ...
        factura.setBackground(new java.awt.Color(153, 255, 153));
        factura.setFont(new java.awt.Font("Kristen ITC", 1, 14)); // NOI18N
        ...
        jPanel4.add(factura, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 420, 180, 50));
    ...
    private void btnNuevoClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoClienteActionPerformed
        ...
        desbloqueoTxt();
        btnIngresoCliente.setEnabled(true);
        agregarCompra.setEnabled(true);
